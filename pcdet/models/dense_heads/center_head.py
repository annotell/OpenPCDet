        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            if "iou" in pred_dict or self.model_cfg.get("IOU_REG_LOSS", False):
                ...
                if "iou" in pred_dict:
                    ...
                    """# Ensure the mask & indices don't exceed iou_preds shape
                    max_preds = (
                        pred_dict["iou"].shape[2] * pred_dict["iou"].shape[3]
                    )  # Total available predictions per sample
                    ...
                    target_boxes = target_dicts["target_boxes_src"][idx][
                        :, :max_preds, :
                    ]"""
